...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("Resources/new.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action->setIcon(icon);
        action_3 = new QAction(MainWindowClass);
        action_3->setObjectName(QStringLiteral("action_3"));
        QIcon icon1;
        icon1.addFile(QStringLiteral("Resources/scene.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("Resources/saveLocal.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_saveLocal->setIcon(icon2);
        action_6 = new QAction(MainWindowClass);
        action_6->setObjectName(QStringLiteral("action_6"));
        QIcon icon3;
        icon3.addFile(QStringLiteral("Resources/setting.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral("Resources/grid.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_startMesh->setIcon(icon4);
        action_9 = new QAction(MainWindowClass);
        action_9->setObjectName(QStringLiteral("action_9"));
        QIcon icon5;
        icon5.addFile(QStringLiteral("Resources/select.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral("Resources/select1.ico"), QSize(), QIcon::Normal, QIcon::Off);
        computerOption->setIcon(icon6);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral("Resources/all.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_ShowAll->setIcon(icon7);
        action_obj = new QAction(MainWindowClass);
        action_obj->setObjectName(QStringLiteral("action_obj"));
        QIcon icon8;
        icon8.addFile(QStringLiteral("Resources/obj.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_obj->setIcon(icon8);
        action_matFile = new QAction(MainWindowClass);
        action_matFile->setObjectName(QStringLiteral("action_matFile"));
        QIcon icon9;
        icon9.addFile(QStringLiteral("Resources/material.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_matFile->setIcon(icon9);
        ...
        QIcon icon10;
        icon10.addFile(QStringLiteral("Resources/simulation.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_localscene->setIcon(icon10);
        action_loadPlugin = new QAction(MainWindowClass);
        action_loadPlugin->setObjectName(QStringLiteral("action_loadPlugin"));
        QIcon icon11;
        icon11.addFile(QStringLiteral("Resources/pluginInsert.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_loadPlugin->setIcon(icon11);
        ...
        QIcon icon12;
        icon12.addFile(QStringLiteral("Resources/delete.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon14;
        icon14.addFile(QStringLiteral("Resources/json.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_json->setIcon(icon14);
        ...
        QIcon icon15;
        icon15.addFile(QStringLiteral("Resources/point.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_showPoint->setIcon(icon15);
        ...
        QIcon icon16;
        icon16.addFile(QStringLiteral("Resources/line.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_showLine->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QStringLiteral("Resources/face.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_showFace->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QStringLiteral("Resources/generate.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_GenerateModelPara->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QStringLiteral(":/MainWindow/Resources/scatter.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_scatter->setIcon(icon19);
        ...
        QIcon icon20;
        icon20.addFile(QStringLiteral("Resources/sava.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_saveResult->setIcon(icon20);
        action_loadResult = new QAction(MainWindowClass);
        action_loadResult->setObjectName(QStringLiteral("action_loadResult"));
        QIcon icon21;
        icon21.addFile(QStringLiteral("Resources/data.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_loadResult->setIcon(icon21);
    ...
    void retranslateUi(QMainWindow *MainWindowClass)
    {
        ...
        action->setShortcut(QApplication::translate("MainWindowClass", "Ctrl+N", 0));
