...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("image/ico/scene.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral("image/ico/saveLocal.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral("image/ico/grid.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_startMesh->setIcon(icon2);
        action_9 = new QAction(MainWindowClass);
        action_9->setObjectName(QStringLiteral("action_9"));
        QIcon icon3;
        icon3.addFile(QStringLiteral("image/ico/select.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_9->setIcon(icon3);
        computerOption = new QAction(MainWindowClass);
        computerOption->setObjectName(QStringLiteral("computerOption"));
        QIcon icon4;
        icon4.addFile(QStringLiteral("image/ico/setting.ico"), QSize(), QIcon::Normal, QIcon::Off);
        computerOption->setIcon(icon4);
        action_obj = new QAction(MainWindowClass);
        action_obj->setObjectName(QStringLiteral("action_obj"));
        QIcon icon5;
        icon5.addFile(QStringLiteral("image/ico/obj.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_obj->setIcon(icon5);
        action_matFile = new QAction(MainWindowClass);
        action_matFile->setObjectName(QStringLiteral("action_matFile"));
        QIcon icon6;
        icon6.addFile(QStringLiteral("image/ico/material.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_matFile->setIcon(icon6);
        action_loadPlugin = new QAction(MainWindowClass);
        action_loadPlugin->setObjectName(QStringLiteral("action_loadPlugin"));
        QIcon icon7;
        icon7.addFile(QStringLiteral("image/ico/pluginInsert.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_loadPlugin->setIcon(icon7);
        action_deletePlugin = new QAction(MainWindowClass);
        action_deletePlugin->setObjectName(QStringLiteral("action_deletePlugin"));
        QIcon icon8;
        icon8.addFile(QStringLiteral("image/ico/delete.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_deletePlugin->setIcon(icon8);
        action_run = new QAction(MainWindowClass);
        action_run->setObjectName(QStringLiteral("action_run"));
        QIcon icon9;
        icon9.addFile(QStringLiteral("image/ico/run.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_run->setIcon(icon9);
        action_json = new QAction(MainWindowClass);
        action_json->setObjectName(QStringLiteral("action_json"));
        QIcon icon10;
        icon10.addFile(QStringLiteral("image/ico/json.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_json->setIcon(icon10);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral("image/ico/point.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_showPoint->setIcon(icon11);
        ...
        QIcon icon12;
        icon12.addFile(QStringLiteral("image/ico/line.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_showLine->setIcon(icon12);
        ...
        QIcon icon13;
        icon13.addFile(QStringLiteral("image/ico/face.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_showFace->setIcon(icon13);
        action_scatter = new QAction(MainWindowClass);
        action_scatter->setObjectName(QStringLiteral("action_scatter"));
        QIcon icon14;
        icon14.addFile(QStringLiteral("image/ico/result.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_scatter->setIcon(icon14);
        action_saveResult = new QAction(MainWindowClass);
        action_saveResult->setObjectName(QStringLiteral("action_saveResult"));
        QIcon icon15;
        icon15.addFile(QStringLiteral("image/ico/save.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_saveResult->setIcon(icon15);
        action_loadResult = new QAction(MainWindowClass);
        action_loadResult->setObjectName(QStringLiteral("action_loadResult"));
        QIcon icon16;
        icon16.addFile(QStringLiteral("image/ico/data.ico"), QSize(), QIcon::Normal, QIcon::Off);
        action_loadResult->setIcon(icon16);
        actionHelp = new QAction(MainWindowClass);
        actionHelp->setObjectName(QStringLiteral("actionHelp"));
        QIcon icon17;
        icon17.addFile(QStringLiteral("image/ico/help.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mainToolBar->addAction(action_saveLocal);
        mainToolBar->addAction(action_saveResult);
        mainToolBar->addAction(action_loadResult);
        mainToolBar->addSeparator();
        mainToolBar->addAction(action_startMesh);
        mainToolBar->addSeparator();
        mainToolBar->addAction(computerOption);
    ...
    void retranslateUi(QMainWindow *MainWindowClass)
    {
        ...
        action_startMesh->setShortcut(QApplication::translate("MainWindowClass", "Ctrl+P", 0));
        action_9->setText(QApplication::translate("MainWindowClass", "\346\235\220\346\226\231\351\200\211\351\241\271", 0));
        computerOption->setText(QApplication::translate("MainWindowClass", "\350\256\276\347\275\256", 0));
        action_obj->setText(QApplication::translate("MainWindowClass", "\345\257\274\345\205\245obj\346\250\241\345\236\213(\344\273\205\346\237\245\347\234\213\357\274\211", 0));
        action_matFile->setText(QApplication::translate("MainWindowClass", "\345\257\274\345\205\245\346\235\220\350\264\250\346\226\207\344\273\266", 0));
        ...
        action_scatter->setText(QApplication::translate("MainWindowClass", "\346\225\243\347\202\271\346\212\230\347\272\277\345\233\276", 0));
#ifndef QT_NO_TOOLTIP
        action_scatter->setToolTip(QApplication::translate("MainWindowClass", "\346\225\243\347\202\271\346\212\230\347\272\277\345\233\276", 0));
#endif // QT_NO_TOOLTIP
        ...
        actionHelp->setText(QApplication::translate("MainWindowClass", "\347\224\250\346\210\267\346\211\213\345\206\214", 0));
