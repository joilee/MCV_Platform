...
#define SP_TCP6_PROTOCOL                    0x00000008
...
/* Product capabilty code for XM key */
#define SP_TYPE_XM_KEY                 0x00000100
...
#define SP_MAX_NUM_SERVERS					100 /* The maximum number of servers that can be enumerated */
...
#define	SP_SOFTWARE_KEY_LEN					280  
#define	SP_MIN_ENCRYPT_DATA_LEN					16
#define	SP_MAX_QUERY_LEN					112
/*
 * Changed length from 256 to 2032
 */
#define	SP_MAX_RAW_LEN						2032
#define	SP_MAX_STRING_LEN					2032
...
SP_EXPORT SP_STATUS SP_API SFNTSetConfigFile(SP_IN SPP_CHAR configFilePath);
#endif
